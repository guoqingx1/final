...
class ASPP_dense(nn.Module):
    def __init__(self, backbone, output_stride, BatchNorm):
        super(ASPP_dense, self).__init__()
        if backbone == 'drn':
            inplanes = 512
...
def build_aspp_dense(backbone, output_stride, BatchNorm):
    return ASPP_dense(backbone, output_stride, BatchNorm)
