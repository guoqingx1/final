...
class CrackSegmentation(Dataset):
    ...
    def __init__(self,
        ...
        print('Denses Added')
        self._feat_dir = os.path.join(self._base_dir, 'Denses')
        ...
        for splt in self.split:
            ...
            for ii, line in enumerate(lines):
                ...
                # print('name of the file is: ', _feat)
                assert os.path.isfile(_feat)
#                 print('name of the file is: ', _image)
    ...
    def __getitem__(self, index):
        _img, _target, _feat = self._make_img_gt_point_pair(index)
        sample = {'image': _img, 'label': _target, 'feature': _feat}
    ...
    def _make_img_gt_point_pair(self, index):
        ...
        _feat = Image.open(self.features[index])

        return _img, _target, _feat
